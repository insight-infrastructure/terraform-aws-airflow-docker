...
[![open-issues](https://img.shields.io/github/issues-raw/insight-infrastructure/terraform-aws-airflow-docker?style=for-the-badge)](https://github.com/insight-infrastructure/terraform-aws-airflow-docker/issues)
[![open-pr](https://img.shields.io/github/issues-pr-raw/insight-infrastructure/terraform-aws-airflow-docker?style=for-the-badge)](https://github.com/insight-infrastructure/terraform-aws-airflow-docker/pulls)
...
- [defaults](https://github.com/insight-infrastructure/terraform-aws-airflow-docker/tree/master/examples/defaults)
...
| device\_name | The path of the EBS volume | `string` | `"/dev/xvdf"` | no |
| domain\_name | The domain - example.com. Blank for no ssl / nginx | `string` | `""` | no |
| ebs\_volume\_size | Size of attached ebs volume | `number` | `8` | no |
...
| public\_ports | List of publicly open ports | `list(number)` | <pre>[<br>  22,<br>  80,<br>  3000,<br>  9090<br>]</pre> | no |
